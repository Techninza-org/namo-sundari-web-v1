...
export default function AboutPage() {
  const values = [
    {
      ...
      title: "Natural & Pure",
      description:
        "100% natural ingredients sourced ethically from sacred groves and traditional farms across India.",
    },
    {
  ...
  const milestones = [
    {
      year: "2018",
      event: "Founded with a vision to revive ancient aromatherapy",
    },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Namoh Sundari was born from a deep reverence for ancient wisdom
              and a passion for bringing the healing power of sacred scents to
              modern souls seeking spiritual connection.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="font-playfair text-3xl font-bold text-brand-maroon">
                Meet Our Founder
              </h2>
              <p className="text-lg text-gray-700 leading-relaxed">
                "My journey began in the sacred temples of Varanasi, where I
                first experienced the transformative power of ancient
                aromatherapy. After years of studying under traditional masters
                and traveling across India to source the purest ingredients, I
                founded Namoh Sundari to share these sacred scents with the
                world."
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                "Each fragrance we create carries the essence of spiritual
                traditions, crafted with the same reverence and purity that has
                been passed down through generations. Our mission is to help
                souls reconnect with their divine essence through the power of
                sacred scents."
              </p>
              <div className="pt-4">
                <p className="font-playfair text-xl font-semibold text-brand-maroon">
                  Priya Sundari
                </p>
                <p className="text-brand-gold font-medium">
                  Founder & Master Aromatherapist
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Every aspect of our work is guided by these fundamental principles
              that honor both tradition and sustainability.
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From a small vision to a growing community of souls seeking
              authentic spiritual fragrances.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              Become part of a growing family of souls who have discovered the
              transformative power of sacred scents. Together, we're preserving
              ancient wisdom while creating a more mindful, connected world.
            </p>
            <Button
              size="lg"

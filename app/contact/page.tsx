      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="font-playfair text-5xl md:text-6xl font-bold text-brand-maroon mb-6">Connect With Us</h1>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              We'd love to hear from you. Whether you have questions about our products, need guidance on your spiritual
              journey, or want to share your experience, we're here to help.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
              ...
              >
                <Card className="h-full border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-8 text-center">
                    ...
                    <h3 className="font-playfair text-xl font-semibold text-brand-maroon mb-4">{info.title}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              <Card className="border-0 shadow-xl bg-white/90 backdrop-blur-sm">
                <CardContent className="p-8">
                  <h2 className="font-playfair text-3xl font-bold text-brand-maroon mb-6">Send Us a Message</h2>
                  ...
                  {isSubmitted ? (
                    ...
                    >
                      ...
                      <h3 className="font-playfair text-2xl font-semibold text-brand-maroon mb-2">Message Sent!</h3>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          <Label htmlFor="subject" className="text-brand-maroon font-medium">
                            Subject *
                          </Label>
                          <Select
                          ...
                          >
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="zodiac-guidance">Zodiac Guidance</SelectItem>
                      ...
                      <div>
                        <Label htmlFor="message" className="text-brand-maroon font-medium">
                          Message *
                        </Label>
                        <Textarea
                          id="message"
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="font-playfair text-3xl font-bold text-brand-maroon mb-8">Frequently Asked Questions</h2>
              <div className="space-y-6">
                {faqs.map((faq, index) => (
                  <Card key={index} className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
                    <CardContent className="p-6">
                      <h3 className="font-playfair text-lg font-semibold text-brand-maroon mb-3">{faq.question}</h3>
